...
hoistedDependencies:
  ...
  '@types/libsodium-wrappers@0.7.14':
    '@types/libsodium-wrappers': private
  '@vitest/expect@2.1.9':
    '@vitest/expect': private
  '@vitest/mocker@2.1.9(vite@5.4.21(@types/node@22.19.6))':
  ...
  p-locate@5.0.0:
    p-locate: private
  packages/gateway:
    '@ondc-agent/gateway': private
  packages/seller-sdk:
    '@ondc-agent/seller-sdk': private
  packages/shared:
    '@ondc-agent/shared': private
  parent-module@1.0.1:
  ...
  uri-js@4.4.1:
    uri-js: private
  vite-node@2.1.9(@types/node@22.19.6):
    vite-node: private
...
pendingBuilds: []
prunedAt: Wed, 14 Jan 2026 15:34:23 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - '@rollup/rollup-win32-x64-gnu@4.55.1'
  - '@rollup/rollup-win32-x64-msvc@4.55.1'
storeDir: /Users/gurusharan/Library/pnpm/store/v3
